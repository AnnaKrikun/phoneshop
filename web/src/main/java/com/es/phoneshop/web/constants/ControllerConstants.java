...
public class ControllerConstants {
    public static final String ADMIN_ORDERS_MAPPING = "/admin/orders";
    public static final String CART_MAPPING = "/cart";
    public static final String ORDER_OVERVIEW_MAPPING = "/orderOverview/{orderId}";
